...
- (void)showCompletionMessage:(NSString *)message {
    ...
    icon.frame = CGRectMake((panelWidth - iconSize) / 2.0, 20.0, iconSize, iconSize);
    icon.tintColor = UIColor.systemGreenColor;
    icon.contentMode = UIViewContentModeScaleAspectFit;
    [panel addSubview:icon];

    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(16.0, 72.0, panelWidth - 32.0, 48.0)];
