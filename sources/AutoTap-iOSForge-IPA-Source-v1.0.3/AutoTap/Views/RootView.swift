...
private struct LandingLayout {
    ...
    init(size: CGSize) {
        ...
        actionFontSize = isVeryShort ? 11 : (hideDetailText ? 13 : (useCompactLayout ? 14 : 15))
        actionButtonHeight = isVeryShort ? 22 : (hideDetailText ? 32 : (useCompactLayout ? 38 : 42))
    }
}
