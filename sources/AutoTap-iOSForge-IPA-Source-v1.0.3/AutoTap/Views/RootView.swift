...
private struct LandingLayout {
    ...
    init(size: CGSize) {
        ...
        let useCompactLayout = size.height < 820 || (isLandscape && size.height < 620)
        ...
        actionFontSize = useUltraCompactLayout ? 10 : (hideDetailText ? 12 : (useCompactLayout ? 14 : 16))
        actionVerticalPadding = useUltraCompactLayout ? 3 : (hideDetailText ? 5 : (useCompactLayout ? 6 : 9))
