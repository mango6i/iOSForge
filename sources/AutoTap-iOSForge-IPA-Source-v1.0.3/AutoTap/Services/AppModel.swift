...
final class AppModel: ObservableObject {
    ...
    private func pauseForDeviceLock() {
        ...
        // Never destroy a WindowServer context or HID client during the lock
        // transition. Suppression above makes the active module's callback
        // return before entering the main queue; unlocking restores that same
        // independent module in an explicitly paused/armed state.
        setScreenAwake(false)
