...
final class AppModel: ObservableObject {
    ...
    private func pauseForDeviceLock() {
        ...
        // Match the proven v1.0.2 lock path: pause and redraw the existing HUD,
        // but never unregister a private WindowServer context while SpringBoard
        // is entering the lock screen. That registration transition can block
        // SpringBoard and make the whole device appear frozen.
        setScreenAwake(false)
