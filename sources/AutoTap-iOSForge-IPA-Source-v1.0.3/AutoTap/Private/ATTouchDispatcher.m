...
- (BOOL)sendAtX:(CGFloat)x y:(CGFloat)y phase:(ATTouchPhase)phase {
    ...
    uint32_t parentMask = ATDigitizerEventPosition;
    uint32_t childMask = ATDigitizerEventPosition;
    if (phase == ATTouchPhaseDown) {
        parentMask |= ATDigitizerEventRange | ATDigitizerEventTouch | ATDigitizerEventIdentity;
        childMask |= ATDigitizerEventRange | ATDigitizerEventTouch | ATDigitizerEventIdentity;
    } else if (phase == ATTouchPhaseUp) {
        parentMask |= ATDigitizerEventRange | ATDigitizerEventTouch;
