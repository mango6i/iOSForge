...
- (void)updateOverlayContentInPlace {
    ...
    self.toolbar.alpha = (executing ? 0.20 : 1.0) * [self controlOpacityOrDefault];
...
/// User-facing opacity for the floating control bar; falls back to fully
/// opaque until the model publishes a value.
...
- (void)buildToolbar {
    ...
    panel.alpha = ((self.running && !self.paused) ? 0.20 : 1.0) * [self controlOpacityOrDefault];
